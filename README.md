...
Most Xtream Codes IPTV providers keep a catchup archive for their channels, usually going back a few days.
...
- M3U-only providers aren't supported here. The EPG + timeshift flow needs the Xtream API.
